...
|related_position|Sets the position (sort order) of the SKUs that are listed as Related Products in the related_skus column. For example: `1,2,3,4`|
|crosssell_skus|Lists the sku of each product that has been identified as a Cross-sell.|
|crosssell_position|Sets the position (sort order) of the SKUs that are listed as Cross-sell Products in the crosssell_skus column.|
|upsell_skus|Lists the sku of each product that has been identified as an Up-sell.|
|upsell_position|Sets the position (sort order) of the SKUs that are listed as Up-sell Products in the upsell_skus column.|
